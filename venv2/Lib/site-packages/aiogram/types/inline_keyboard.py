...
class InlineKeyboardMarkup(base.TelegramObject):
    """
    This object represents an inline keyboards that appears right next to the message it belongs to.
...
class InlineKeyboardButton(base.TelegramObject):
    """
    This object represents one button of an inline keyboards. You must use exactly one of the optional fields.
