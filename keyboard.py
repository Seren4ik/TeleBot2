...
greet_kb = ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True).add(btnStart, btnHelp, btnStartProject, btnAndProject, btnCancel, btnReminders, btnViewProject, btnDelProject)